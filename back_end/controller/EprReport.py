...
class EprReport:
    ...
    def getEpr(self, table_name: str):
    ...
    def getResumeEpr(self, table_name: str):
        ...
        try:
            ...
            columns =  result.keys() if hasattr(result, "keys") else [
                 ...
                 "nb_clients", "total_montant_epr", "total_debit_epr", "total_credit_epr"
            ]
    ...
    def get_graphe_dataEpr(self, x: str, y: str, table_name:str):
        table_name_vrai = f"epr_{table_name}"
        if not table_name_vrai or not table_name_vrai.startswith("epr_"):
                raise ValueError("Nom de table invalide")
        conn = None
