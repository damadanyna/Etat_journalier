...
const fetchUser = async () => {
  try {
    const response = await axios.get(`${api}/api/userPaie/${props.userId}`, {
...
const confirmValidation = async () => {
  ...
  try {
    ...
    const response = await axios.post(`${api}/api/validate_user_paie`, formData, {
      headers: { Authorization: `Bearer ${localStorage.getItem('access_token')}` }
    })
...
const confirmRoleChange = async () => {
  ...
  try {
    ...
    const response = await axios.post(`${api}/api/update_user_role_paie`, formData, {
      headers: { Authorization: `Bearer ${localStorage.getItem('access_token')}` }
    })
...
const confirmBlockUser = async () => {
  ...
  try {
    ...
    const response = await axios.post(`${api}/api/block_user_paie`, formData, {
      headers: { Authorization: `Bearer ${localStorage.getItem('access_token')}` }
    })
